...
export async function POST(req: Request) {
  try {
    ...
    let systemPrompt = [
      ...
      "",
      "【1. 清潔感 cleanliness】見た目・髪型・肌・爪・服装・体臭",
      ...
      "",
      "【5. 距離を縮める力 dateActions】誘う・連絡・好意を伝える・エスコート・実行",
      ...
      "",
      "【6. 生活習慣 lifestyle】睡眠・食事・部屋の整理・規則正しい生活・喫煙・飲酒の改善",
      "タバコをやめた・禁酒した・お酒を控えたなど、喫煙・飲酒の改善も生活習慣カテゴリで評価すること。",
      "10: 睡眠・食事・運動バランス完璧、部屋も常に整理整頓、喫煙・飲酒の悪習慣なし",
      "9: 生活リズム安定、健康的な習慣が身についている",
      "8: 基本的に規則正しい、たまに乱れる程度",
      "7: 意識して生活習慣を整えている、改善中（喫煙・飲酒の節制・改善含む）",
      "6: 最低限の生活習慣、大きな乱れはない",
      "5: 普通の生活、特に意識していない",
      "4: 生活リズムが乱れがち、夜更かし多い",
      "3: 不規則な生活、食事も偏りがち",
      ...
      "1: 生活習慣が崩壊、健康にも影響",
      "",
      "【7. 話す力 speakingSkill】自分から話しかける・会話をリード・盛り上げる",
      ...
      "1: ほとんど話せない、会話を避けている",
      "",
      "【8. 聞く力・共感力 listeningSkill】相手の話を聞く・共感・質問・褒める",
      ...
      "1: 非常にネガティブ、自己否定が強い",
      "",
      "【10. 継続力 consistency】毎日コツコツ・習慣化・やり抜く",
